...
//   const [dateTimeInput, setDateTimeInput] = useState(""); // for input field
//   const [dateTimeSelection, setDateTimeSelection] = useState({}); // for storing dates
...
//           <span
//             key={time}
//             className="bg-primary/20 px-3 py-1 rounded cursor-pointer"
...
const AddShow = () => {
  ...
  const handleAddShow = () => {
    ...
    if (Object.keys(dateTimeSelection).length === 0) {
      alert("Please add at least one date & time");
      return;
    }
  ...
  return nowPlayingMovies.length > 0 ? (
    <>
      ...
      <button
        ...
        className='bg-primary text-white px-8 py-2 mt-6 rounded hover:bg-primary/90 transition'
      >
        Add Show
      </button>
    </>
